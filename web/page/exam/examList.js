layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var uid = JSON.parse(window.sessionStorage.getItem('user')).id;
    //新闻列表
    var tableIns = table.render({
        elem: '#newsList',
        url: '/getExamList.action?id=' + uid,
        cellMinWidth: 95,
        page: true,
        height: "full-125",
        limit: 20,
        ...
        cols: [[
            ...
            {field: 'examName', title: '试题名称', width: 550},
            ...
            //     sort:true,
            //     minWidth: 100,
            //     templet:'<div>{{d.user.nickname ? d.user.nickname: ""}}</div>'
            // },

            {
                field: 'd.user.nickname', title: '发布者',
